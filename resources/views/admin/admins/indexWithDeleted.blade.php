        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4 style="color:#EE877C">Admin > All With Deleted</h4>
                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center px-3">
                                                ...
                                                <div class="d-flex px-2">
                                                    <a href="{{route('admin.admins.restore', $item->id)}}" class="btn btn-sm btn-outline-success" style="margin-right: 5px">
                                                    ...
                                                    <form id="delete-form-{{$item->id}}" action="{{route('admin.admins.forceDelete', $item->id)}}" method="post">
                                                        @csrf
                                                    </form>
                                                </div>
                                                @endif
