            ...
            <div class="container">
                ...
                <div class="login-form">
                    <form action="{{ route('login') }}" method="post">
                        @csrf
                        <input class="@error('email') is-invalid @enderror" name="email" type="text" placeholder="E-mail..."
                               value="{{ old('email') }}">
                        @error('email')
                        ...
                        <input class="@error('password') is-invalid @enderror" name="password" type="password" placeholder="Password..."
                               value="{{ old('password') }}">
                        @error('password')
                        <span class="invalid-feedback mb-4" role="alert">
                            <strong>{{ $message }}</strong>
